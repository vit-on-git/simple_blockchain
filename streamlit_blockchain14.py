...
from simple_blockchain6 import Blockchain, Block  # Add Block here
...
def load_blockchain():
    ...
    if blocks:
        for block in blocks:
            blockchain.chain.append(Block(  # Change this line
                index=block['index'],
...
st.title("🛠️ Simple Blockchain Explorer v.14-6")
