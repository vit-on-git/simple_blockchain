...
from simple_blockchain6 import Blockchain, Block  # ✅ Import Block explicitly
...
def load_blockchain():
    ...
    if blocks:
        blockchain.chain = []  # Clear default genesis block
        for block in blocks:
            blockchain.chain.append(Block(  # ✅ Properly reconstruct Block instances
                index=block['index'],
